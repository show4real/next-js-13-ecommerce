              ...
              <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-white p-8 rounded-lg w-11/12 md:max-w-md">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Send your friends a 2% discount off their purchase. Once
                    they make a purchase, you'll earn 5% commission for each
                    order as well! This reward can be redeemed for coupons.
                  </p>
                  <input
