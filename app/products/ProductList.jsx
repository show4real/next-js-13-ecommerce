...
export default function ProductList({
  ...
  const ReferAndEarnBadge = () => {
    ...
    return (
      <>
        {showBadge && (
          <div className="fixed bottom-10 right-3 z-50 bg-blue-500 text-white px-6 py-3 rounded-lg flex items-center">
            <div className="mr-2">
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white p-8 rounded-lg w-11/12 md:max-w-md">
              ...
              <p className="text-sm text-gray-600 mb-4">
                ...
                make a purchase, you will earn 5% commission for each order as
